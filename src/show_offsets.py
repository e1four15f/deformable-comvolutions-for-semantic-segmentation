"""
The module taken from: https://github.com/ziplab/LIT/blob/main/classification/code_for_lit_ti/show_offset.py
"""
...
def show_dconv_offset_v2(im, all_offset, step=[2, 2], filter_size=3,
                      dilation=2, pad=2, plot_area=2, plot_level=3, image_name=None):
    vis_attr = {'filter_size': filter_size, 'dilation': dilation, 'pad': pad,
                'plot_area': plot_area, 'plot_level': plot_level}
